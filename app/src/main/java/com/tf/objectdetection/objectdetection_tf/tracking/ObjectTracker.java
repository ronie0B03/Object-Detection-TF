...
package com.tf.objectdetection.objectdetection_tf.tracking;
...
import com.tf.objectdetection.objectdetection_tf.env.Size;
...
//
      ...
      return new RectF( frameWidth - (downsampledFrameRect.right * DOWNSAMPLE_FACTOR),
              downsampledFrameRect.top * DOWNSAMPLE_FACTOR,
